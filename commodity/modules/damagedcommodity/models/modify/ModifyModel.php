...
namespace commodity\modules\damagedcommodity\models\modify;

use Yii;
use common\models\Model as CommonModel;
use commodity\modules\damagedcommodity\models\modify\db\Update;
...
class ModifyModel extends CommonModel {
    ...
    public $token;
    public $name; //姓名 
    public $damagedcommodity_number; //工号 
    public $damagedcommodity_type_name; //工种名 
    ...
    public function scenarios() {
        return [
            self::ACTION_MODIFY => [
                'name', 'phone_number', 'damagedcommodity_number', 'damagedcommodity_type_name', 'qq_number', 'basic_salary', 'ability', 'attendance_code', 'ID_card_image', 'ID_code', 'comment', 'token'
            ],
            self::ACTION_LEAVE => [
    ...
    public function actionModify() {
        ...
        try {
            ...
            $post_data['damagedcommodity_number'] = $this->damagedcommodity_number;
            $post_data['name'] = $this->name;
            $post_data['damagedcommodity_type_name'] = $this->damagedcommodity_type_name;
            ...
            //整理参数
            $modify_damagedcommodity_data = PutModel::prepareData($post_data, false);



            $condition['store_id'] = $modify_damagedcommodity_data['store_id'];
            $condition['damagedcommodity_number'] = $this->damagedcommodity_number;
            unset($modify_damagedcommodity_data['damagedcommodity_number']);
//            print_r($condition);
//            die;
            //更改操作
            if (!Update::modifyEmployee($condition, $modify_damagedcommodity_data)) {
    ...
    public function actionLeave() {
        ...
        try {
            ...
            $modify_damagedcommodity_data['status'] = 1;
            //更改操作
            if (Update::modifyAllEmployee($condition, $modify_damagedcommodity_data) === false) {
    ...
    public function actionOpen() {
        ...
        try {
            ...
            $modify_damagedcommodity_data['status'] = 0;
            //更改操作
            if (Update::modifyAllEmployee($condition, $modify_damagedcommodity_data) === false) {
