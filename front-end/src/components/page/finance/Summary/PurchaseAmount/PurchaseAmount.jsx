...
import './PurchaseAmount.styl'
import Columns from './PurchaseAmount.columns'
...
class PurchaseAmount extends Component {
  ...
  getData({ startDate = '', endDate = '', searchTime = 'month', page = 1 }) {
    ajax({
      method: 'GET',
      url: '/finance/get/purchase-statistics-lists.do',
      data: {
        startDate,
        endDate,
        searchTime,
      ...
      this.setState({
        total: info.data.purchase_total_number,
      ...
      <div className="crm-basic-page crm-finance-cost-page" ref={ wrapper => this.wrapper = wrapper }>
        ...
        <div className="crm-table-control">
          <div className="crm-table-total">
            总采购数量: <span id="Amount">{ this.state.total }</span>
          </div>
