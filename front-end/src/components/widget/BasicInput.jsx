...
class Input extends Component {
  ...
  render() {
    const { text, DplComponent, pageInstance, parentInstance, icon, noLabel, data, ...rest } = this.props
    ...
    return (
      <div className="crm-input">
        ...
        <div className={ DplComponent ? 'dpl' : '' }>
          { DplComponent ? <DplComponent data={ data } pageInstance={ pageInstance } { ...rest } /> : <input ref={ ipt => parentInstance ? parentInstance.ipt = ipt : null } type="text" placeholder={ '请输入' + text } { ...rest } /> }
